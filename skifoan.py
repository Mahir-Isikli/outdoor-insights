...
def ski_builder(n): 
    ski_characteristics = pd.DataFrame(columns=('opt_speed', 'opt_pressure', "opt_len", "max_speed","driver_level","ski_model"))
    for i in range(n):
        ...
        ski_characteristics.loc[len(ski_characteristics.index)] = [ opt_speed, opt_pressure, opt_len, max_speed, driver_level]
